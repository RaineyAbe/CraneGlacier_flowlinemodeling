...
function [U,dUdx,vm,T] = U_convergence(x,U,U0,dUdx,dhdx,H,A,E,N,W,dx,c,ice_end,n,m,beta,rho_i,rho_sw,g)
...
while b
    ...
    %set velocity past the ice end
    if Un(ice_end)==0
        Un(ice_end) = Un(ice_end-1);
    end
