%% Script to tune the basal roughness factor beta, using observations of glacier speed and geometry.
% Rainey Aberle
% 2020-2021
...
save_betabest = 0;  % = 1 to save the beta with the lowest U RMSE
save_results = 0;   % = 1 to save all solution results 
