...
beta0 = [0.6 1.1 0.8 0.9 1.7 2.0 2.0*ones(1,5)]; % initial guess for beta
...
% define settings
DFWBounds = [0 10]; % range of possible fwd values (m)
method = 'b';       % = 'g' to solve by gradient descent, or 'b' to solve by brute force
